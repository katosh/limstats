...
function stats(D,dias,Lab,Labs,in,out)
	...
	for i=loops
		...
		printf(["\n Mediana Recepcionadas/dia:		",num2str(Frec)]);
		printf(["\n Mediana Terminaciones/dia:		",num2str(Fter)]);
		printf(["\n Mediana duracion de Muestra en Cesmec:	",num2str(floor(dura / 86400)),strftime(' dias y %R',gmtime(dura))]);
		printf(["\n Mediana duracion en Recepcion:		",num2str(floor(duraR / 86400)),strftime(' dias y %R',gmtime(duraR))]);
		printf(["\n Mediana duracion en Laboratorio:	",num2str(floor(duraL / 86400)),strftime(' dias y %R',gmtime(duraL))]);
		printf(["\n Mediana duracion en Despacho:		",num2str(floor(duraD / 86400)),strftime(' dias y %R',gmtime(duraD))]);
		printf(["\n Mediana duracion de Trabajo en lab.:	",num2str(floor(duraT / 86400)),strftime(' dias y %R',gmtime(duraT))]);
		printf(["\n Mediana numero de equipo en proceso:	",num2str(equipo)]);
		printf(["\n Mediana duracion Teorica:		",num2str(floor(duraTeorica / 86400)),strftime(' dias y %R',gmtime(duraTeorica))]);
		printf(["\n Mediana len de trabajo por dia:	",strftime('%R',gmtime(ldia))]);
